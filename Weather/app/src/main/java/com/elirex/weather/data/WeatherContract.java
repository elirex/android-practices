...
public class WeatherContract {
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherLocation(String locatonSetting) {
            return CONTENT_URI.buildUpon().appendPath(locatonSetting).build();
        }
        ...
        public static Uri buildWeatherLocationWithDate(String locatoinSetting,
                                                       long date) {
            return CONTENT_URI.buildUpon().appendPath(locatoinSetting)
